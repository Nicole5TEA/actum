...
const ActuaEscenario = () => {
        ...
        return (
          <Box textAlign="center" mb={1}>
             <img 
                ...
                loading="lazy" // Añadido para optimización
              />
            {/* Título "CONSECUENCIA PROBABLE" movido aquí y en negrita */}
            <Typography variant="h6" component="div" sx={{ fontWeight: 'bold', mt: 2 }}>
                {data.ui.pasoTituloResultado || pasoActual.titulo} {/* Usar clave de textos.js */}
            </Typography>
  ...
  let mostrarSiguienteBoton = !showFeedback || (showFeedback && esUltimaDelNivelActual) || (showFeedback && !esUltimaDelNivelActual);
  if (showFeedback) {
  ...
  return (
    <>
      ...
      <Container maxWidth="md" sx={{ pt: 1, position: 'relative', pb: {xs: isSmUp ? 2 : 10, sm: 2} }}>
        ...
        {/* Título principal de la escena/situación */}
          ...
          <Stack direction="row" spacing={2} justifyContent="center" mb={2} flexWrap="wrap">
            {escena.pictos.map((pic, i) => ( 
              <Box 
                ...
                alt={`Picto ${i + 1}`} 
                sx={{
                  width: {xs: 55, sm: 70}, // Ajuste de tamaño de pictogramas
                  height: {xs: 55, sm: 70},
                }} 
              /> 
            ))}
        ...
        {/* El título específico del paso (SITUACIÓN, ¿QUÉ PUEDE HACER...?, CONSECUENCIA) se renderiza DENTRO de renderStepContent */}
